...
cp -R ./src/stacks/commons ./build/src/app/
...
node ./src/generator/generator.js --metadata ./build/metadata.yaml --template ./src/templates/services.ts.hbs --output ./build/src/app/services
