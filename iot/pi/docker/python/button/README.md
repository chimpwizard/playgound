...
# Using Docker to program the Raspberry Pi - python - blink a LED pressing a button
...
The goal of this POC is have te RPi to blink a led using a button using python inside docker container

### to run

```shell
npm run start:button:python
```
