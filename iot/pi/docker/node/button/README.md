...
# Using Docker to program the Raspberry Pi - nodejs - blink a LED pressing a button
...
The goal of this POC is have te RPi to blink a led using a button using nodejs inside docker container
